...
export const Section1 = () => {
  ...
  return (
    ...
    >
      <div className={`${mwidth.isTabletDevice ? "w-full" : "w-[60%] "}`}>
        <div className="my-10">
          <Image
            src={halfspher}
        ...
        {mwidth.isTabletDevice ? (
          <>
            <div className="w-full">
              <p className={`${poppins.className} text-[#1E1E1E]`}>
                {/* <b> */}
                ...
                markets. We offer a wide range of products and services, such as
      ...
      <div
        className={`flex relative  gap-6 ${
          mwidth.isTabletDevice ? "w-full" : "w-[30%] "
        } justify-center`}
      >
        <div className="h-100 relative top-20">
          <Image
            src={img1}
            className={` ${
