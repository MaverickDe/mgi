...
export const Section2 = () => {
  ...
  return (
    <div className="flex w-full gap-10 mt-[200px]">
      <div className="w-[50%]">
        <h2 className="mb-10  text-[25px]">
          <b>Founders Bio</b>
        </h2>
        {mwidth.isTabletDevice ? (
          <p className={`${poppins.className} text-[#1E1E1E] text-[10px]`}>
            Marshall Goodwill was Founded in August 2023, our company's
            visionary founding team instills a commitment to excellence and
            progress in all our endeavors.
          </p>
        ) : (
          <p
            className={`${poppins.className} text-[#1E1E1E] font-[400px] leading-2`}
          >
      ...
      <div className="w-[50%] flex flex-col items-center ">
        <div className="h-100">
          <Image src={img3} className="w-30 p-0 m-0" priority loading="eager" />
        </div>
